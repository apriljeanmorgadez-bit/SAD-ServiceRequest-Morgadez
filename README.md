...
2. Actors
System User / ICT Personnel – the only actor for this exercise. After logging in, this user can create, view, search, filter, update, and delete service requests, and view the dashboard summary.
